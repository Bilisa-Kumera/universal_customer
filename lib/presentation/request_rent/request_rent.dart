...
import 'package:universal_customer/presentation/request_rent/request_confirm.dart';

class RequestRentPage extends StatelessWidget {
  const RequestRentPage({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            CustomButton(
                onPressed: () {
                  NavigationHelper.push(context, RequestConfirm());
                },
